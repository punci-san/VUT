...
class Syntax
{
  ...
  function __construct()
  {
    ...
    // Array of instructions where each instruction contains array of syntax rules
    // symb = symb or var
  ...
  // Checks if given string is instruction
  public function isInstruction($string)
  {
    // Loop through each item in instruction array
