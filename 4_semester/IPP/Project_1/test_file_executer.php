...
class TestExecuter
{
  ...
  public function TestInterpreter($file_array)
  {
    ...
    foreach ($file_array as $key => $value)
    {
      ...
      // Execute script
      exec("python3.7 ".$this->intName. " --source=".$src . " < ".$in . " > ".$this->tmpFileName,$output,$return);
  ...
  public function TestBoth($file_array)
  {
    ...
    foreach ($file_array as $key => $value)
    {
      ...
      exec("python3.7 ".$this->intName. " --source=".$this->tmpFileName . " < ".$in." > ".$this->tmpFileName."2",$output,$return);
